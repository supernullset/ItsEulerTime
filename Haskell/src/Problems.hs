...
zeroZeroOne :: Int
zeroZeroOne = sum $ filtered [0..999]
  where
...
zeroZeroTwo :: Int
zeroZeroTwo = sum [x | x <- takeWhile (<= 4000000) fibs, even x]
  where
    fibs = 0 : 1 : zipWith (+) fibs (tail fibs)

-- The prime factors of 13195 are 5, 7, 13 and 29.
-- What is the largest prime factor of the number 600851475143 ?
zeroZeroThree :: [Integer]
zeroZeroThree = filter L.isPrime $ L.factors 600851475143
